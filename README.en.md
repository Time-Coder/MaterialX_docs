...
- Select the `MATERIALX_BUILD_VIEWER` option to build the [MaterialX Viewer](docs_en/documents/DeveloperGuide/Viewer.md).
- Select the `MATERIALX_BUILD_GRAPH_EDITOR` option to build the [MaterialX Graph Editor](docs_en/documents/DeveloperGuide/GraphEditor.md).
...
The [MaterialX Viewer](docs_en/documents/DeveloperGuide/Viewer.md) leverages shader generation to build GLSL shaders from MaterialX graphs, rendering the results using the NanoGUI framework.
