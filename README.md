...
- 选择 `MATERIALX_BUILD_VIEWER` 选项以构建 [MaterialX 查看器](docs_ch/documents/DeveloperGuide/Viewer.md)。
- 选择 `MATERIALX_BUILD_GRAPH_EDITOR` 选项以构建 [MaterialX 图形编辑器](docs_ch/documents/DeveloperGuide/GraphEditor.md)。
...
[MaterialX 查看器](docs_ch/documents/DeveloperGuide/Viewer.md) 利用着色器生成从 MaterialX 图构建 GLSL 着色器，使用 NanoGUI 框架渲染结果。
